...
import com.example.user.friidgeandroid.AddProduct;
...
public class DisplayUserProducts extends ListActivity {
    ...
    private static String url_all_products = Configuration.ipAdressServer +"/getallproducts.php";
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DisplayUserProducts.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            DisplayUserProducts.this, productsList,
